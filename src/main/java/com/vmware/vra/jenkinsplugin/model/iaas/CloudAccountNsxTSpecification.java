 ...
 */
@Schema(description = "Specification for an NSX-T cloud account.<br><br>A cloud account identifies a cloud account type and an account-specific deployment region or data center where the associated cloud account resources are hosted.")
...
public class CloudAccountNsxTSpecification {
   ...
   * @return hostName
  **/
  @Schema(example = "nsxt.mycompany.com", required = true, description = "Host name for the NSX-T endpoint")
