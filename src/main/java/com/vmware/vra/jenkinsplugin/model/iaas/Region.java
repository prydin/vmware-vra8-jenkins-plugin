 ...
 */
@Schema(description = "State object representing a region in a cloud account.<br>**HATEOAS** links:<br>**cloud-account** - CloudAccount - Cloud account for the region.**self** - Region - Self link to this region")
...
public class Region {
  ...
  **/
  @Schema(example = "us-west", required = true, description = "Unique identifier of region on the provider side.")
  ...
  **/
   ...
   * @return name
  **/
  @Schema(example = "us-west", description = "Name of region on the provider side. In vSphere, the name of the region is different from its id.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(owner, organizationId, createdAt, _links, externalRegionId, cloudAccountId, name, id, orgId, updatedAt);
  }
