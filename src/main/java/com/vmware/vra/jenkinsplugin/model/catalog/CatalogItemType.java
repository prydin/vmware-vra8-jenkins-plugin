...
public class CatalogItemType {
  ...
  **/
   ...
   * @return configSchema
  **/
  @Schema(description = "Configuration schema for this type, requests to create a source of this type should have a compliant 'config' field")
  ...
  **/
   ...
   * @return id
  **/
  @Schema(description = "Human-readable unique ID containing only lowercase letters and periods, neither starting nor ending with a period, and never having two consecutive periods")
  public String getId() {
    return id;
  }
