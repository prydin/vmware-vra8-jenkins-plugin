 ...
 */
@Schema(description = "Specification for an NSX-v cloud account.<br><br>A cloud account identifies a cloud account type and an account-specific deployment region or data center where the associated cloud account resources are hosted.")
...
public class CloudAccountNsxVSpecification {
   ...
   * @return hostName
  **/
  @Schema(example = "nsxv.mycompany.com", required = true, description = "Host name for the NSX-v endpoint")
  ...
  **/
  @Schema(example = "[ \"42f3e0d199d134755684cd935435a\" ]", description = "vSphere cloud account associated with this NSX-V cloud account. NSX-V cloud account can be associated with a single vSphere cloud account.")
   ...
   * @return dcid
  **/
  @Schema(example = "23959a1e-18bc-4f0c-ac49-b5aeb4b6eef4", required = true, description = "Identifier of a data collector vm deployed in the on premise infrastructure. Refer to the data-collector API to create or list data collectors")
