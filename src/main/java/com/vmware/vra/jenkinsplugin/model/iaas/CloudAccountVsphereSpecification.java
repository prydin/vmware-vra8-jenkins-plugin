 ...
 */
@Schema(description = "Specification for a vSphere cloud account.<br><br>A cloud account identifies a cloud account type and an account-specific deployment region or data center where the associated cloud account resources are hosted.")
...
public class CloudAccountVsphereSpecification {
   ...
   * @return hostName
  **/
  @Schema(example = "vc.mycompany.com", required = true, description = "Host name for the vSphere endpoint")
  ...
  **/
  @Schema(example = "[ \"42f3e0d199d134755684cd935435a\" ]", description = "NSX-V or NSX-T account to associate with this vSphere cloud account. vSphere cloud account can be a single NSX-V cloud account or a single NSX-T cloud account.")
  ...
  **/
   ...
   * @return regionIds
  **/
  @Schema(example = "[ \"Datacenter:datacenter-2\" ]", required = true, description = "A set of datacenter managed object reference identifiers (MoRef) to enable provisioning on. Refer to /iaas/cloud-accounts-vsphere/region-enumeration.")
   ...
   * @return username
  **/
  @Schema(example = "administrator@mycompany.com", required = true, description = "Username to authenticate with the cloud account")
