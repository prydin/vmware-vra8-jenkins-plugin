...
import com.vmware.vra.jenkinsplugin.model.iaas.Claims;
import com.vmware.vra.jenkinsplugin.model.iaas.DelegatingUserSubjectInfo;
import com.vmware.vra.jenkinsplugin.model.iaas.Query;
import com.vmware.vra.jenkinsplugin.model.iaas.QueryFilter;
...
public class AuthorizationContext {
  ...
  public AuthorizationContext putCommonQueryClauseMapItem(String key, Query commonQueryClauseMapItem) {
  ...
  **/
  ...
  public AuthorizationContext delegatingUserSubjectInfo(DelegatingUserSubjectInfo delegatingUserSubjectInfo) {
  ...
  **/
  ...
  public AuthorizationContext putAllowedActionsByPathItem(String key, List<InnerEnum> allowedActionsByPathItem) {
    if (this.allowedActionsByPath == null) {
      this.allowedActionsByPath = new HashMap<String, InnerEnum<String>>();
    }
    this.allowedActionsByPath.put(key, allowedActionsByPathItem);
    return this;
  }
  ...
  **/
  ...
  public AuthorizationContext resourceQueryFilterMap(Map<String, QueryFilter> resourceQueryFilterMap) {
    this.resourceQueryFilterMap = resourceQueryFilterMap;
    return this;
  }

  public AuthorizationContext putResourceQueryFilterMapItem(String key, QueryFilter resourceQueryFilterMapItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.commonQueryClauseMap, authorizationContext.commonQueryClauseMap) &&
        ...
        Objects.equals(this.delegatingUserSubjectInfo, authorizationContext.delegatingUserSubjectInfo) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(commonQueryClauseMap, resourceQueryMap, delegatingUserSubjectInfo, subject, aclEnabled, claims, systemUser, allowedActionsByPath, resourceQueryFilterMap, additionalData, guestUser, token);
  }
  ...
  public String toString() {
    ...
    sb.append("    commonQueryClauseMap: ").append(toIndentedString(commonQueryClauseMap)).append("\n");
    sb.append("    resourceQueryMap: ").append(toIndentedString(resourceQueryMap)).append("\n");
    sb.append("    delegatingUserSubjectInfo: ").append(toIndentedString(delegatingUserSubjectInfo)).append("\n");
    ...
    sb.append("    allowedActionsByPath: ").append(toIndentedString(allowedActionsByPath)).append("\n");
    sb.append("    resourceQueryFilterMap: ").append(toIndentedString(resourceQueryFilterMap)).append("\n");
