...
public class StorageProfileVsphereSpecification {
  ...
  **/
  @Schema(example = "false", description = "Indicates whether this storage profile supports encryption or not.")
   ...
   * @return sharesLevel
  **/
  @Schema(example = "low / normal / high / custom", description = "Shares are specified as High, Normal, Low or Custom and these values specify share values with a 4:2:1 ratio, respectively. ")
  ...
  **/
  @Schema(example = "thin / thick / eagerZeroedThick", description = "Type of provisioning policy for the disk.")
  ...
  **/
   ...
   * @return limitIops
  **/
  @Schema(example = "1000", description = "The upper bound for the I/O operations per second allocated for each virtual disk.")
  ...
  **/
   ...
   * @return defaultItem
  **/
  @Schema(example = "true", required = true, description = "Indicates if a storage profile acts as a default storage profile for a disk.")
   ...
   * @return diskType
  **/
  @Schema(example = "standard / firstClass", description = "Disk types are specified as     Standard - Simple vSphere virtual disks which cannot be managed independently without an attached VM.  First Class - Improved version of standard virtual disks, designed to be fully mananged independent storage objects.   Empty value is considered as Standard")
