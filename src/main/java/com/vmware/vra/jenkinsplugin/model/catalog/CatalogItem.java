...
public class CatalogItem {
  ...
  **/
   ...
   * @return schema
  **/
  @Schema(description = "Json schema describing request parameters, a simplified version of http://json-schema.org/latest/json-schema-validation.html#rfc.section.5")
