...
import com.vmware.vra.jenkinsplugin.model.iaas.ImageMappingDescription;
 ...
 */
@Schema(description = "Describes an image mapping between image key and fabric image.<br>**HATEOAS** links:<br>**region** - Region - Region for the mapping.")
...
public class ImageMapping {
   ...
   * @return mapping
  **/
  @Schema(example = "{ \"ubuntu\" : {\"externalRegionId\": \"us-east-1\", \"externalId\": \"ami-2c7b5656\", \"name\": \"ami-ubuntu-16.04\", \"description\": \"instance-store - HVM - supports - UTF-8 - tools\"} }", required = true, description = "Image mapping defined for the particular region.")
