...
public class User {
   ...
   * @return type
  **/
  @Schema(example = "user", description = "Type of the principal. Currently supported 'user' (default) and 'group'.")
   ...
   * @return email
  **/
  @Schema(example = "administrator@vmware.com", required = true, description = "The email of the user or name of the group.")
