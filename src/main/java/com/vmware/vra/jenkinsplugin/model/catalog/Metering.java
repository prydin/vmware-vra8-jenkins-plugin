...
public class Metering {
  ...
  public enum ChargeBasedOnEnum {
    ...
    public static class Adapter extends TypeAdapter<ChargeBasedOnEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ChargeBasedOnEnum enumeration) throws IOException {
  ...
  public enum ChargeOnPowerStateEnum {
    ...
    public static class Adapter extends TypeAdapter<ChargeOnPowerStateEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ChargeOnPowerStateEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(baseRate, chargeBasedOn, chargeOnPowerState, chargePeriod, fixedPrice, unit);
  }
