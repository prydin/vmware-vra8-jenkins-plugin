 ...
 */
@Schema(description = "State object representing a deployment.<br>**HATEOAS** links:<br>**self** - Deployment - Self link to this deployment")
...
public class Deployment {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(owner, organizationId, createdAt, _links, name, description, id, projectId, orgId, updatedAt);
  }
