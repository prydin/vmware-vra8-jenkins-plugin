...
public class StorageProfileAwsSpecification {
   ...
   * @return deviceType
  **/
  @Schema(example = "ebs / instance-store", required = true, description = "Indicates the type of storage.")
   ...
   * @return volumeType
  **/
  @Schema(example = "gp2 / io1 / sc1 / st1 / standard", description = "Indicates the type of volume associated with type of storage.")
  ...
  **/
   ...
   * @return regionId
  **/
  @Schema(example = "31186", required = true, description = "A link to the region that is associated with the storage profile.")
