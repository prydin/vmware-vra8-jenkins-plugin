...
import net.virtualviking.vra.jenkinsplugin.model.catalog.PolicyFeatureConfig;

/**
 * A type of policy that includes the schema of the policy itself and the schema of the objects affected by the policy
 */
@ApiModel(description = "A type of policy that includes the schema of the policy itself and the schema of the objects affected by the policy")
...
public class PolicyType {
   ...
   * @return config
  **/
  @ApiModelProperty(value = "Defines configuration options for policy type")
  ...
  **/
  @ApiModelProperty(required = true, value = "Schema describing a policy object of this type")
   ...
   * @return displayName
  **/
  @ApiModelProperty(required = true, value = "Policy type display-name/label")
   ...
   * @return id
  **/
  @ApiModelProperty(required = true, value = "Policy type ID")
  public String getId() {
    return id;
  }
   ...
   * @return name
  **/
  @ApiModelProperty(required = true, value = "Policy type name")
   ...
   * @return targetSchema
  **/
  @ApiModelProperty(required = true, value = "Schema describing objects that can be affected by this policy")
