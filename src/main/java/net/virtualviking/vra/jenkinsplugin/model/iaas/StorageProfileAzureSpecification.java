 ...
 */
@ApiModel(description = "Represents a specification of Azure storage profile.")
...
public class StorageProfileAzureSpecification {
  ...
  **/
  @ApiModelProperty(example = "aaa82", value = "Id of a storage account where in the disk is placed.")
  ...
  **/
  @ApiModelProperty(example = "false", value = "Indicates whether this storage policy should support encryption or not.")
   ...
   * @return regionId
  **/
  @ApiModelProperty(example = "31186", required = true, value = "The If of the region that is associated with the storage profile.")
  ...
  **/
   ...
   * @return defaultItem
  **/
  @ApiModelProperty(example = "true", value = "Indicates if a storage policy contains default storage properties.")
  ...
  **/
   ...
   * @return tags
  **/
  @ApiModelProperty(example = "\"[ { \\\"key\\\" : \\\"tier\\\", \\\"value\\\": \\\"silver\\\" } ]\"", value = "A set of tag keys and optional values for a storage policy which define set of specifications for creating a disk.")
