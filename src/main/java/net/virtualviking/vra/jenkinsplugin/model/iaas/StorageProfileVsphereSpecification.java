 ...
 */
@ApiModel(description = "Represents a specification of vSphere storage profile.")
...
public class StorageProfileVsphereSpecification {
  ...
  **/
   ...
   * @return sharesLevel
  **/
  @ApiModelProperty(example = "low / normal / high / custom", value = "Shares are specified as High, Normal, Low or Custom and these values specify share values with a 4:2:1 ratio, respectively. ")
  ...
  **/
  @ApiModelProperty(example = "6b59743af31d", value = "Id of the vSphere Storage Policy to be applied.")
  ...
  **/
  @ApiModelProperty(example = "thin / thick / eagerZeroedThick", value = "Type of provisioning policy for the disk.")
  ...
  **/
   ...
   * @return limitIops
  **/
  @ApiModelProperty(example = "1000", value = "The upper bound for the I/O operations per second allocated for each virtual disk.")
  ...
  **/
   ...
   * @return defaultItem
  **/
  @ApiModelProperty(example = "true", required = true, value = "Indicates if a storage profile acts as a default storage profile for a disk.")
   ...
   * @return diskType
  **/
  @ApiModelProperty(example = "standard / firstClass", value = "Disk types are specified as     Standard - Simple vSphere virtual disks which cannot be managed independently without an attached VM.  First Class - Improved version of standard virtual disks, designed to be fully mananged independent storage objects.   Empty value is considered as Standard")
   ...
   * @return datastoreId
  **/
  @ApiModelProperty(example = "08d28", value = "Id of the vSphere Datastore for placing disk and VM.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    StorageProfileVsphereSpecification storageProfileVsphereSpecification = (StorageProfileVsphereSpecification) o;
    return Objects.equals(this.supportsEncryption, storageProfileVsphereSpecification.supportsEncryption) &&
        ...
        Objects.equals(this.provisioningType, storageProfileVsphereSpecification.provisioningType) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(supportsEncryption, sharesLevel, description, diskMode, storagePolicyId, tags, shares, provisioningType, regionId, limitIops, name, defaultItem, diskType, datastoreId);
  }
