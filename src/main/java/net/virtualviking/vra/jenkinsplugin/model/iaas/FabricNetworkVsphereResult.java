...
import net.virtualviking.vra.jenkinsplugin.model.iaas.FabricNetworkVsphere;

/**
 * State object representing a query result of fabric networks.
 */
@ApiModel(description = "State object representing a query result of fabric networks.")
