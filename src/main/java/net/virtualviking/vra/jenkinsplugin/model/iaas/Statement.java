...
import net.virtualviking.vra.jenkinsplugin.model.iaas.Connection;
import net.virtualviking.vra.jenkinsplugin.model.iaas.ResultSet;
...
public class Statement {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(queryTimeout, updateCount, maxFieldSize, resultSetConcurrency, closeOnCompletion, fetchSize, largeUpdateCount, warnings, generatedKeys, moreResults, fetchDirection, resultSet, maxRows, resultSetHoldability, resultSetType, poolable, largeMaxRows, closed, connection);
  }
  ...
  public String toString() {
    ...
    sb.append("    resultSetConcurrency: ").append(toIndentedString(resultSetConcurrency)).append("\n");
