 ...
 */
@ApiModel(description = "Represents fabric flavor instance type description. Used when creating flavor profiles.")
...
public class FabricFlavorDescription {
   ...
   * @return memoryInMB
  **/
  @ApiModelProperty(example = "4096", value = "Total amount of memory (in megabytes). Mandatory for private clouds such as vSphere. Not populated when inapplicable.")
   ...
   * @return name
  **/
  @ApiModelProperty(example = "t2.small, t2.medium", value = "The value of the instance type in the corresponding cloud. Valid and mandatory for public clouds")
   ...
   * @return cpuCount
  **/
  @ApiModelProperty(example = "4", value = "Number of CPU cores. Mandatory for private clouds such as vSphere. Not populated when inapplicable.")
