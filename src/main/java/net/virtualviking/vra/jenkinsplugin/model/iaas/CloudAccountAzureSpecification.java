 ...
 */
@ApiModel(description = "Specification for a Azure cloud account.<br><br>A cloud account identifies a cloud account type and an account-specific deployment region or data center where the associated cloud account resources are hosted.")
...
public class CloudAccountAzureSpecification {
  ...
  **/
  @ApiModelProperty(example = "3287dd6e-76d8-41b7-9856-2584969e7739", required = true, value = "Azure Client Application ID")
  ...
  **/
  @ApiModelProperty(example = "GDfdasDasdASFas321das32cas2x3dsXCSA76xdcasg=", required = true, value = "Azure Client Application Secret Key")
  ...
  **/
   ...
   * @return tenantId
  **/
  @ApiModelProperty(example = "9a13d920-4691-4e2d-b5d5-9c4c1279bc9a", required = true, value = "Azure Tenant ID")
  ...
  **/
   ...
   * @return regionIds
  **/
  @ApiModelProperty(example = "\"[ \\\"East US\\\", \\\"North Europe\\\" ]\"", required = true, value = "A set of Region names to enable provisioning on. Refer to /iaas/cloud-accounts-azure/region-enumeration..")
  ...
  **/
  @ApiModelProperty(example = "064865b2-e914-4717-b415-8806d17948f7", required = true, value = "Azure Subscribtion ID")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CloudAccountAzureSpecification cloudAccountAzureSpecification = (CloudAccountAzureSpecification) o;
    return Objects.equals(this.createDefaultZones, cloudAccountAzureSpecification.createDefaultZones) &&
        Objects.equals(this.clientApplicationId, cloudAccountAzureSpecification.clientApplicationId) &&
        Objects.equals(this.clientApplicationSecretKey, cloudAccountAzureSpecification.clientApplicationSecretKey) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createDefaultZones, clientApplicationId, clientApplicationSecretKey, name, tenantId, description, regionIds, subscriptionId, tags);
  }
  ...
  public String toString() {
    ...
    sb.append("    clientApplicationSecretKey: ").append(toIndentedString(clientApplicationSecretKey)).append("\n");
