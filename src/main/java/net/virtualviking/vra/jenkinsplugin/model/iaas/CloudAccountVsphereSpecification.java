 ...
 */
@ApiModel(description = "Specification for a vSphere cloud account.<br><br>A cloud account identifies a cloud account type and an account-specific deployment region or data center where the associated cloud account resources are hosted.")
...
public class CloudAccountVsphereSpecification {
   ...
   * @return hostName
  **/
  @ApiModelProperty(example = "vc.mycompany.com", required = true, value = "Host name for the vSphere endpoint")
  ...
  **/
  @ApiModelProperty(example = "\"[ \\\"42f3e0d199d134755684cd935435a\\\" ]\"", value = "NSX-V or NSX-T account to associate with this vSphere cloud account. vSphere cloud account can be a single NSX-V cloud account or a single NSX-T cloud account.")
  ...
  **/
   ...
   * @return regionIds
  **/
  @ApiModelProperty(example = "\"[ \\\"Datacenter:datacenter-2\\\" ]\"", required = true, value = "A set of datacenter managed object reference identifiers (MoRef) to enable provisioning on. Refer to /iaas/cloud-accounts-vsphere/region-enumeration.")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CloudAccountVsphereSpecification cloudAccountVsphereSpecification = (CloudAccountVsphereSpecification) o;
    return Objects.equals(this.hostName, cloudAccountVsphereSpecification.hostName) &&
        Objects.equals(this.acceptSelfSignedCertificate, cloudAccountVsphereSpecification.acceptSelfSignedCertificate) &&
        Objects.equals(this.associatedCloudAccountIds, cloudAccountVsphereSpecification.associatedCloudAccountIds) &&
        Objects.equals(this.password, cloudAccountVsphereSpecification.password) &&
        Objects.equals(this.createDefaultZones, cloudAccountVsphereSpecification.createDefaultZones) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hostName, acceptSelfSignedCertificate, associatedCloudAccountIds, password, createDefaultZones, dcid, name, description, regionIds, username, tags);
  }
