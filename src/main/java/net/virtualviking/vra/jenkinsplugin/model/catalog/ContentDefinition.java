 ...
 */
@ApiModel(description = "Represents a catalog item or content source that is linked to a project via an entitlement.")
...
public class ContentDefinition {
   ...
   * @return description
  **/
  @ApiModelProperty(value = "Description of either the catalog item or the catalog source")
   ...
   * @return iconId
  **/
  @ApiModelProperty(value = "Icon id of associated catalog item (if association is with catalog item)")
   ...
   * @return id
  **/
  @ApiModelProperty(required = true, value = "Id of either the catalog source or catalog item.")
  public UUID getId() {
    return id;
  }
   ...
   * @return name
  **/
  @ApiModelProperty(value = "Name of either the catalog item or the catalog source")
   ...
   * @return numItems
  **/
  @ApiModelProperty(value = "Number of items in the associated catalog source")
   ...
   * @return sourceName
  **/
  @ApiModelProperty(value = "Catalog source name")
   ...
   * @return sourceType
  **/
  @ApiModelProperty(value = "Catalog source type")
   ...
   * @return type
  **/
  @ApiModelProperty(required = true, value = "Content definition type")
