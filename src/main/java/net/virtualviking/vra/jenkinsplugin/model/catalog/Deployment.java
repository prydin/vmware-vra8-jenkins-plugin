...
import net.virtualviking.vra.jenkinsplugin.model.catalog.Expense;
import net.virtualviking.vra.jenkinsplugin.model.catalog.Request;
import net.virtualviking.vra.jenkinsplugin.model.catalog.Resource;
import net.virtualviking.vra.jenkinsplugin.model.catalog.ResourceReference;
 ...
 */
@ApiModel(description = "A group of resources such as machines, network, software, etc... typically provisioned together to deliver a complete/workable application.")
...
public class Deployment {
   ...
   * @return blueprint
  **/
  @ApiModelProperty(value = "Expanded deployment blueprint")
   ...
   * @return blueprintId
  **/
  @ApiModelProperty(value = "Deployment blueprint id")
  ...
  **/
  @ApiModelProperty(value = "Deployment blueprint version")
   ...
   * @return catalog
  **/
  @ApiModelProperty(value = "Expanded deployment catalog")
  ...
  **/
  @ApiModelProperty(value = "Deployment catalog item id")
  ...
  **/
  @ApiModelProperty(value = "Deployment catalog version")
  ...
  **/
   ...
   * @return deleted
  **/
  @ApiModelProperty(value = "Indicates whether the deployment is deleted or not.")
   ...
   * @return description
  **/
  @ApiModelProperty(value = "Description of the deployment")
   ...
   * @return expense
  **/
  @ApiModelProperty(value = "Expense associated with the deployment.")
   ...
   * @return iconId
  **/
  @ApiModelProperty(value = "Deployment icon id")
   ...
   * @return id
  **/
  @ApiModelProperty(value = "Id of the deployment")
  public UUID getId() {
    return id;
  }
   ...
   * @return inputs
  **/
  @ApiModelProperty(value = "The inputs that were used to request this deployment")
   ...
   * @return lastRequest
  **/
  @ApiModelProperty(value = "Last request")
  ...
  **/
  @ApiModelProperty(value = "Lease expiration time")
  ...
  **/
   ...
   * @return project
  **/
  @ApiModelProperty(value = "Expanded deployment project")
   ...
   * @return projectId
  **/
  @ApiModelProperty(value = "Deployment project id")
   ...
   * @return resources
  **/
  @ApiModelProperty(value = "Expanded resources for the deployment. Content of this property will not be maintained backward compatible")
   ...
   * @return status
  **/
  @ApiModelProperty(value = "Deployment status.")
