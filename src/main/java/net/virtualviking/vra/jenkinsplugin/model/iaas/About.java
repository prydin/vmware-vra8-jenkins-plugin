...
import net.virtualviking.vra.jenkinsplugin.model.iaas.ApiDescription;

/**
 * State object representing an about page that includes api versioning information
 */
@ApiModel(description = "State object representing an about page that includes api versioning information")
...
public class About {
  ...
  **/
  @ApiModelProperty(required = true, value = "A collection of all currently supported api versions.")
  ...
  **/
  @ApiModelProperty(required = true, value = "The latest version of the API in yyyy-MM-dd format (UTC).")
