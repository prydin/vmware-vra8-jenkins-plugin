...
import net.virtualviking.vra.jenkinsplugin.model.catalog.FixedPrice;
import net.virtualviking.vra.jenkinsplugin.model.catalog.MeteringItem;
import net.virtualviking.vra.jenkinsplugin.model.catalog.MeteringPolicyAssignmentInfo;
import net.virtualviking.vra.jenkinsplugin.model.catalog.NamedMeteringItem;
import net.virtualviking.vra.jenkinsplugin.model.catalog.OneTimeMeteringItem;
import net.virtualviking.vra.jenkinsplugin.model.catalog.TagBasedMeteringItem;
import net.virtualviking.vra.jenkinsplugin.model.catalog.TagBasedOneTimeMeteringItem;
import net.virtualviking.vra.jenkinsplugin.model.catalog.TagBasedRateFactorItem;
...
public class MeteringPolicy {
  ...
  **/
  @ApiModelProperty(value = "Assignment count, assignment entity type")
