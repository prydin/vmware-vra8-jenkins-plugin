...
import net.virtualviking.vra.jenkinsplugin.model.catalog.Criteria;
import net.virtualviking.vra.jenkinsplugin.model.catalog.DataElement;
import net.virtualviking.vra.jenkinsplugin.model.catalog.PolicyStats;

/**
 * A policy such as lease policy that will be enforced.
 */
@ApiModel(description = "A policy such as lease policy that will be enforced.")
...
public class Policy {
  ...
  **/
  @ApiModelProperty(value = "Defines enforcement type for policy. Default is HARD")
