...
import net.virtualviking.vra.jenkinsplugin.model.iaas.CloudAccountAws;

/**
 * State object representing a query result of Aws cloud accounts.
 */
@ApiModel(description = "State object representing a query result of Aws cloud accounts.")
