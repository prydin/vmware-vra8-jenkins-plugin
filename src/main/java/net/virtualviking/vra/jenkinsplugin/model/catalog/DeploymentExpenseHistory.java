...
import net.virtualviking.vra.jenkinsplugin.model.catalog.TimeSeriesValue;

/**
 * Expense history of a deployment.
 */
@ApiModel(description = "Expense history of a deployment.")
...
public class DeploymentExpenseHistory {
   ...
   * @return currency
  **/
  @ApiModelProperty(value = "The currency code of the expense history.")
   ...
   * @return data
  **/
  @ApiModelProperty(value = "The list of expense history metric.")
   ...
   * @return interval
  **/
  @ApiModelProperty(value = "The requested interval type.")
