 ...
 */
@ApiModel(description = "Represents a Catalog Item that can eventually be requested by a consumer.")
...
public class CatalogItem {
  ...
  **/
  @ApiModelProperty(value = "Max number of instances that can be requested at a time")
  ...
  **/
   ...
   * @return description
  **/
  @ApiModelProperty(value = "CatalogItem description")
   ...
   * @return formId
  **/
  @ApiModelProperty(value = "Form ID")
   ...
   * @return iconId
  **/
  @ApiModelProperty(value = "Icon ID")
   ...
   * @return id
  **/
  @ApiModelProperty(required = true, value = "CatalogItem id")
  public UUID getId() {
    return id;
  }
  ...
  **/
   ...
   * @return name
  **/
  @ApiModelProperty(required = true, value = "CatalogItem name")
   ...
   * @return projectIds
  **/
  @ApiModelProperty(required = true, value = "Associated project IDs that can be used for requesting")
   ...
   * @return projects
  **/
  @ApiModelProperty(value = "Associated projects that can be used for requesting")
   ...
   * @return schema
  **/
  @ApiModelProperty(value = "Json schema describing request parameters, a simplified version of http://json-schema.org/latest/json-schema-validation.html#rfc.section.5")
   ...
   * @return sourceId
  **/
  @ApiModelProperty(value = "LibraryItem source ID.")
   ...
   * @return sourceName
  **/
  @ApiModelProperty(value = "LibraryItem source name.")
   ...
   * @return type
  **/
  @ApiModelProperty(required = true, value = "ResourceReference to type, e.g. blueprint, CFT... etc")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(bulkRequestLimit, createdAt, createdBy, description, formId, iconId, id, lastUpdatedAt, lastUpdatedBy, name, projectIds, projects, schema, sourceId, sourceName, type);
  }
