 ...
 */
@ApiModel(description = "Represents a fabric flavor from the corresponding cloud end-point")
...
public class FabricFlavor {
  ...
  **/
  @ApiModelProperty(example = "486400", value = "Size of the boot disk (in megabytes). Not populated when inapplicable.")
   ...
   * @return memoryInMB
  **/
  @ApiModelProperty(example = "15616", value = "Total amount of memory (in megabytes). Not populated when inapplicable.")
   ...
   * @return name
  **/
  @ApiModelProperty(example = "i3.large", required = true, value = "The value of the instance type in the corresponding cloud.")
   ...
   * @return storageType
  **/
  @ApiModelProperty(example = "NVMe_SSD", value = "The type of storage supported by this instance type. Not populated when inapplicable.")
   ...
   * @return id
  **/
  @ApiModelProperty(example = "i3.large", value = "The internal identification used by the corresponding cloud end-point")
  public String getId() {
    return id;
  }
  ...
  **/
  @ApiModelProperty(example = "486400", value = "Size of the data disks (in megabytes). Not populated when inapplicable.")
  ...
  **/
  @ApiModelProperty(example = "1", value = "Number of data disks. Not populated when inapplicable.")
   ...
   * @return networkType
  **/
  @ApiModelProperty(example = "Up to 10 Gigabit", value = "The type of network supported by this instance type. Not populated when inapplicable.")
   ...
   * @return cpuCount
  **/
  @ApiModelProperty(example = "2", value = "Number of CPU cores. Not populated when inapplicable.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(bootDiskSizeInMB, memoryInMB, name, storageType, id, dataDiskSizeInMB, dataDiskMaxCount, networkType, cpuCount);
  }
