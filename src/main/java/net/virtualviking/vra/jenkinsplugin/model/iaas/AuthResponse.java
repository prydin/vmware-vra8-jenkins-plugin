 ...
 */
@ApiModel(description = "Entity that holds auth token details.")
...
public class AuthResponse {
   ...
   * @return tokenType
  **/
  @ApiModelProperty(example = "Bearer", required = true, value = "Type of the token.")
   ...
   * @return token
  **/
  @ApiModelProperty(required = true, value = "Base64 encoded auth token.")
