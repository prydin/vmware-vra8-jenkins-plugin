 ...
 */
@ApiModel(description = "Represents deployment requests.")
...
public class Request {
   ...
   * @return actionId
  **/
  @ApiModelProperty(value = "Identifier of the requested action")
   ...
   * @return approvedAt
  **/
  @ApiModelProperty(value = "Time at which the request was approved.")
   ...
   * @return blueprintId
  **/
  @ApiModelProperty(value = "Identifier of the requested blueprint in the form 'UUID:version'")
   ...
   * @return cancelable
  **/
  @ApiModelProperty(value = "Indicates whether request can be canceled or not.")
  ...
  **/
  @ApiModelProperty(value = "Identifier of the requested catalog item in the form 'UUID:version'")
   ...
   * @return completedAt
  **/
  @ApiModelProperty(value = "Time at which the request completed.")
  ...
  **/
  @ApiModelProperty(required = true, value = "The number of tasks completed while fulfilling this request.")
   ...
   * @return createdAt
  **/
  @ApiModelProperty(required = true, value = "Creation time (e.g. date format '2019-07-13T23:16:49.310Z').")
   ...
   * @return details
  **/
  @ApiModelProperty(value = "Longer user-friendly details of the request.")
   ...
   * @return dismissed
  **/
  @ApiModelProperty(value = "Indicates whether request is in dismissed state.")
   ...
   * @return id
  **/
  @ApiModelProperty(value = "Request identifier")
  public UUID getId() {
    return id;
  }
  ...
  **/
  @ApiModelProperty(value = "Time at which the request was initialized.")
   ...
   * @return inputs
  **/
  @ApiModelProperty(value = "Request inputs")
   ...
   * @return name
  **/
  @ApiModelProperty(required = true, value = "Short user-friendly label of the request (e.g. 'shuting down myVM')")
   ...
   * @return outputs
  **/
  @ApiModelProperty(value = "Request outputs")
   ...
   * @return requestedBy
  **/
  @ApiModelProperty(required = true, value = "User that initiated the request")
   ...
   * @return resourceName
  **/
  @ApiModelProperty(value = "Optional resource name to which the request applies to")
   ...
   * @return status
  **/
  @ApiModelProperty(value = "Request overall execution status.")
   ...
   * @return totalTasks
  **/
  @ApiModelProperty(required = true, value = "The total number of tasks need to be completed to fulfil this request.")
   ...
   * @return updatedAt
  **/
  @ApiModelProperty(value = "Last update time (e.g. date format '2019-07-13T23:16:49.310Z').")
