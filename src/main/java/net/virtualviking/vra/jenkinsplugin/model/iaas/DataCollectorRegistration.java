 ...
 */
@ApiModel(description = "Data collector registration object.<br>The supplied data collector is an OVA tool that contains the credentials and protocols needed to create a connection between a data collector appliance on a host vCenter and a vCenter-based cloud account. . The process of deploying data collector is: <br> 1. Download the data collector ova from the \"ovaLink\".<br>2. Import the .ova file to the vCenter Server and start the installation.<br> 3. When asked for the key, copy and use the \"key\" provided.<br> 4. It takes a few minutes to detect your Data Collector after it is deployed and powered on in vCenter.")
...
public class DataCollectorRegistration {
   ...
   * @return ovaLink
  **/
  @ApiModelProperty(example = "https://ci-data-collector.s3.amazonaws.com/VMware-Cloud-Services-Data-Collector.ova", required = true, value = "Data collector OVA Link")
   ...
   * @return key
  **/
  @ApiModelProperty(example = "eyJyZWdpc3RyYXRpb25VcmwiOiJodHRwczovL2Fw", required = true, value = "A registration key for the data collector")
