...
import net.virtualviking.vra.jenkinsplugin.model.iaas.HealthCheckConfiguration;

/**
 * Load balancer route configuration.
 */
@ApiModel(description = "Load balancer route configuration.")
...
public class RouteConfiguration {
   ...
   * @return protocol
  **/
  @ApiModelProperty(example = "TCP, UDP", required = true, value = "The protocol of the incoming load balancer requests.")
   ...
   * @return port
  **/
  @ApiModelProperty(example = "80", required = true, value = "Port which the load balancer is listening to.")
   ...
   * @return memberPort
  **/
  @ApiModelProperty(example = "80", required = true, value = "Member port where the traffic is routed to.")
  ...
  **/
  @ApiModelProperty(example = "TCP, UDP", required = true, value = "The protocol of the member traffic.")
  ...
  **/
  @ApiModelProperty(value = "Health check configuration for this route configuration.")
  ...
  **/
  @ApiModelProperty(example = "uriLength=10 urlParam=section", value = "Parameters need for load balancing algorithm.Use newline to separate multiple parameters.")
   ...
   * @return algorithm
  **/
  @ApiModelProperty(example = "ROUND_ROBIN", value = "Algorithm employed for load balancing.")
