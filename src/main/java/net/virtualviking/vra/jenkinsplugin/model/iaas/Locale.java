...
public class Locale {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(unicodeLocaleKeys, country, displayName, iso3Language, displayVariant, language, iso3Country, displayLanguage, script, unicodeLocaleAttributes, displayCountry, variant, extensionKeys, displayScript);
  }
