 ...
 */
@ApiModel(description = "Specification for creating or updating a NetworkIPRange")
...
public class NetworkIPRangeSpecification {
  ...
  **/
  @ApiModelProperty(value = "The Id of the parent fabric network.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(ipVersion, fabricNetworkId, name, description, startIPAddress, endIPAddress, tags);
  }
