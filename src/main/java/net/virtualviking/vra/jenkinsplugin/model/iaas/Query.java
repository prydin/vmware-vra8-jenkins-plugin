...
import net.virtualviking.vra.jenkinsplugin.model.iaas.Query;
import net.virtualviking.vra.jenkinsplugin.model.iaas.QueryTerm;
...
public class Query {
  ...
  public enum OccuranceEnum {
    ...
    public static class Adapter extends TypeAdapter<OccuranceEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final OccuranceEnum enumeration) throws IOException {
