...
import net.virtualviking.vra.jenkinsplugin.model.catalog.CatalogItemResourceUpfrontPriceResponse;

/**
 * The response to a catalog item upfront price request
 */
@ApiModel(description = "The response to a catalog item upfront price request")
...
public class CatalogItemUpfrontPriceResponse {
  ...
  **/
  @ApiModelProperty(value = "Compute Price of the catalog.")
  ...
  **/
  @ApiModelProperty(value = "Network Price of the catalog.")
  ...
  **/
  @ApiModelProperty(value = "Storage Price of the catalog.")
  ...
  **/
  @ApiModelProperty(value = "Total Price of the catalog.")
