 ...
 */
@ApiModel(description = "Represents request events.")
...
public class Event {
   ...
   * @return details
  **/
  @ApiModelProperty(value = "Longer user-friendly details of the event.")
   ...
   * @return hasLogs
  **/
  @ApiModelProperty(value = "Indicates whether the event has logs or not.")
  ...
  **/
   ...
   * @return name
  **/
  @ApiModelProperty(required = true, value = "Short user-friendly label of the event (e.g. 'shutting down myVM')")
   ...
   * @return resourceName
  **/
  @ApiModelProperty(value = "Optional resource name to which the event applies to")
   ...
   * @return resourceType
  **/
  @ApiModelProperty(value = "Optional resource type to which the event applies to")
   ...
   * @return timestamp
  **/
  @ApiModelProperty(required = true, value = "Timestamp of the Event (e.g. date format '2019-07-13T23:16:49.310Z').")
