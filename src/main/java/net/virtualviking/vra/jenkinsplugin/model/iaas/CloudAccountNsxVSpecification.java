 ...
 */
@ApiModel(description = "Specification for an NSX-v cloud account.<br><br>A cloud account identifies a cloud account type and an account-specific deployment region or data center where the associated cloud account resources are hosted.")
...
public class CloudAccountNsxVSpecification {
   ...
   * @return hostName
  **/
  @ApiModelProperty(example = "nsxv.mycompany.com", required = true, value = "Host name for the NSX-v endpoint")
  ...
  **/
  @ApiModelProperty(example = "false", value = "Accept self signed certificate when connecting.")
  ...
  **/
  @ApiModelProperty(example = "\"[ \\\"42f3e0d199d134755684cd935435a\\\" ]\"", value = "vSphere cloud account associated with this NSX-V cloud account. NSX-V cloud account can be associated with a single vSphere cloud account.")
   ...
   * @return dcid
  **/
  @ApiModelProperty(example = "23959a1e-18bc-4f0c-ac49-b5aeb4b6eef4", required = true, value = "Identifier of a data collector vm deployed in the on premise infrastructure. Refer to the data-collector API to create or list data collectors")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.hostName, cloudAccountNsxVSpecification.hostName) &&
        Objects.equals(this.acceptSelfSignedCertificate, cloudAccountNsxVSpecification.acceptSelfSignedCertificate) &&
        Objects.equals(this.password, cloudAccountNsxVSpecification.password) &&
        Objects.equals(this.associatedCloudAccountIds, cloudAccountNsxVSpecification.associatedCloudAccountIds) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hostName, acceptSelfSignedCertificate, password, associatedCloudAccountIds, dcid, name, description, username, tags);
  }
